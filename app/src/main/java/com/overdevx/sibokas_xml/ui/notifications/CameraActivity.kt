...
import com.overdevx.sibokas_xml.databinding.ActivityCameraBinding
...
class CameraActivity : AppCompatActivity() {
    ...
    private fun takePhoto() {
        ...
        Toast.makeText(this@CameraActivity, "test", Toast.LENGTH_SHORT).show()
